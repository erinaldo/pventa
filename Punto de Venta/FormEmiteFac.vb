        ...
        If GrillaArticulos.Rows(0).Cells(0).Value <> "" Then
            If CDbl(lblTotal.Text) > 0 Then
                ...
                If AceptaPago Then
                    ...
                    strComprobanteVenta = intNroComprobante & ";" & intNroComprobanteFiscal & ";" & 5 & ";" & lblIdCliente.Text & ";" &
                        Date.Now & ";" & 3 & ";" & FormatNumber(Pbase, 2) & ";" & PorcIva & ";" & FormatNumber(CDbl(Me.lblTotal.Text), 2) &
                        ";" & idUsuario & ";" & Origen & ";" & FormatNumber(Descuento, 2) & ";" & FormatNumber(TotalDto, 2) & ";" &
                        My.Settings.sucursal & ";" & My.Settings.puestoVenta & ";" & Pagada  ' & ";" & IdFormaPago & ";" & FormaPago
